...
*/
	...
	while (aptMainLoop())
	{
        ...
        if (scene == 2) {
			...
			DrawText("Please note that some of your messages may not appear on your end. Rest assured, they're going through!", 5, 20, 0, 0.6f, 0.6f, C2D_Color32(215, 228, 255, 255), false);
